...
aws events put-targets --rule AmazonGuardDutyFindings --targets Id=1,Arn=arn:aws:lambda:us-east-1:111122223333:function:RespondToAmazonGuardDutyViaDeepSecurity
